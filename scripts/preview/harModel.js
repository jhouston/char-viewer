...
function(Lib, JSONSchema, Ref, HarSchema, CharSchema, Cookies, Trace, Strings) {
...
HarModel.parse = function(jsonString, validate)
{
    ...
    var resolvedSchema = Ref.resolveJson(CharSchema);
...
HarModel.validateRequestTimings = function(input)
{
    ...
    {
        var entry = entries[i];
        if ((entry.entryType != null) && (entry.entryType != "network")) {
            continue;
        }
